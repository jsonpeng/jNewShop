...
class CartController extends Controller
{
    ...
    public function cart(Request $request){
        ...
        $user = auth('web')->user();
        //return $items;
        return view(frontView('cart'), compact('user', 'items', 'count', 'total', 'jifen'));
    }
    ...
    public function postCheck(Request $request)
    {
        try {
            ...
            if ($result['code']) {
                return ['code'=>$result['code'], 'message' => $result['data']];
            } else {
                //清空购物车
                ShoppingCart::clean();
                return ['code'=>0, 'message' => $result['data']->id];
            }
    ...
    public function update(Request $request)
    {
        ...
        return ['code' => 0, 'message' => ['count' => ShoppingCart::count(), 'total' => ShoppingCart::total(), 'qty' => $newQty, 'jifen' => $jifen]];
    }
