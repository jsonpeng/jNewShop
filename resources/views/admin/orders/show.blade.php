        ...
        <div class="box-body">
            <div class="row">
                <form id="price_adjust">
                    ...
                    @if (funcOpen('FUNC_CREDITS') && $order->credits)<div class="col-md-4"><label>{{ getSettingValueByKeyCache('credits_alias') }}抵扣:</label> {{ $order->credits }}{{ getSettingValueByKeyCache('credits_alias') }}抵扣{!! $order->credits_money !!}元 </div>@endif
            ...
            <div class="row">
                <form id="delivery">
                    <div class="col-md-2">
                       ...
                       {{--  <input type="text" class="form-control delivery" name="delivery_company" value="{{ $order->delivery_company }}" placeholder="快递公司"> --}}
