                                    ...
                                    <div class="box-body">
                                        <form class="form-horizontal" id="form1">
                                            ...
                                            <div class="col-sm-4 item">
                                                ...
                                                @if (Config::get('web.FUNC_CREDITS_CARDS'))
                                                <div class="form-group">
                                                    <label for="FUNC_CREDITS_CARDS" class="col-sm-6 control-label"><i class="fa fa-circle-o"></i>{{ getSettingValueByKeyCache('credits_alias') }}卡</label>
                                                    <div class="col-sm-6">
                                                        <input class="weui-switch" type="checkbox" name="FUNC_CREDITS_CARDS" @if(sysOpen('FUNC_CREDITS_CARDS') == '1') checked="checked" @endif />
