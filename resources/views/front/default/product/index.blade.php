...
@section('css')
    <style>
      ...
      .checkwrapper.product-checker{bottom:0; }
    ...
    <div class="classreturn loginsignup detail">
        <div class="content">
            <div class="ds-in-bl return history-back-a">
                <a href="javascript:;"><i class="icon ion-ios-arrow-left"></i></a>
            </div>
...
<div class="content1" id="content1" style="display: block;">
  <div class="switcher">
    ...
    <div class="paras" onclick="showPara()">商品评价({!! count($evals) !!})</div>
  </div>
  <div class="evaluationAndDetails">
      <!-- 产品详情 -->
      ...
      {{-- 评价详情 --}}
      <div class="product-paras" style="display: none">
          @if(count($evals))
              @foreach ($evals as $item)
                <div class="evaluateItem">
                    <div class="weui-cell object">
                        <div class="weui-cell__hd">
                          <img  onerror="javascript:this.src='/images/trade/n1.jpg';" src="@if(!$item->anonymous) {!! $item['publisher']->head_image !!} @endif" alt="">
                        </div>
                        <div class="weui-cell__bd">
                            <p class="userName">@if($item->anonymous) ***  @else {!! $item['publisher']->nickname !!} @endif</p>
...
{{--                     <div class="weui-cell MerchantServices">
                    ...
                    <div class="evaluateLikes" data-id="{!! $item->id !!}" data-zan="0"><span>{!! $item->zan !!}</span><img src="{{ asset('images/trade/likes.png') }}" alt="">
                    </div>

                    <div class="weui-gallery" id="gallery" style="">
  ...
  <div class="checkwrapper product-checker">
    <a class="home checker-left-item" href="/">
      <div class="image"><img src="{{ asset('images/trade/shouye.png') }}" alt=""></div>
...
@section('js')
  ...
  <script type="text/javascript">
    ...
    function anchorDetail(){
      ...
      // $.scrollTo('#product-detail',500);
      var Y = $('#content1').offset().top-46;
      if(Y>0){
          $('.app-wrapper').animate({scrollTop: Y}, 500);
      }
  ...
  <script>
    ...
    $(function(){
      ...
      $('.evaluateLikes').click(function(){
          var that = $(this);
          if(that.data('zan') == 0){
            $.zcjyRequest('/ajax/product_eval_zan/'+that.data('id'),function(res){
                  if(res){
  ...
  <script>
    ...
    $('.evaluateItem  .weui-grids').on("click", ".weui-grid img", function() {
      index = $(this).index();
