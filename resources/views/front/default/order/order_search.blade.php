...
@section('css')
    <style>
        ...
        .nav_tip input{display: inline-block;width:100px;}
    </style>
@endsection
        ...
        <a class="order-item" href="/order/{{$order->id}}">
          ...
          @foreach($order->items as $item)
            ...
            <div class="operation weui-cell">
              ...
              <a class="weui-cell__ft" href="/integral/publish_eva?product_id={{ $item->product_id }}&spec_keyname={{ $item->spec_keyname }}">评价</a>
            </div>
            @endif
          @endforeach
