...
class RolePemessionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $super_admin_user = Admin::create([
            'name' => '超级管理员',
            'email' => 'jidingjia@foxmail.com',
            'password'=>Hash::make('j123456'),
            'type' => '超级管理员',
            'system_tag'=>1
        ]);
        ...
        //店铺分类设置
        $store_cat_set=Permission::create(['name'=>'cats.*','slug'=>'system_store_cat_settings', 'display_name'=>'店铺分类管理', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);
        //店铺设置
        $store_set=Permission::create(['name'=>'stores.*','slug'=>'system_store_settings', 'display_name'=>'店铺管理', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);
        //积分卡设置
        $credit_card_set=Permission::create(['name'=>'cards.*','slug'=>'system_credit_cards_settings', 'display_name'=>'积分卡管理', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);
        //实名认证
        $certs_set=Permission::create(['name'=>'certs.*','slug'=>'system_certs_settings', 'display_name'=>'实名认证管理', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);
